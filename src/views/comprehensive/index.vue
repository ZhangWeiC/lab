  ...
  <div class="compre-container">
    <el-card class="compre-card">
      ...
      <el-row class="btn-container">
        <el-button @click="retEvo" class="left-btn">返回上一项评估</el-button>
        <el-button @click="retList" class="right-btn">返回项目列表</el-button>
      </el-row>
      <el-row :gutter="20">
        ...
        series: [
          {
            ...
            data: [[6560, 8893, 3473, 5273, 6560, 8893, 3473, 5273, 6560, 8893]]
          },
          {
            name: "平均值",
            type: "radar",
            ...
            data: [[5320, 7392, 3966, 5867, 5320, 7392, 3966, 5867, 5320, 7392]]
          }
        ]
      }
    };
